...
func main() {
	slc := []int{2, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6, 1, 3, 7, 8, 4, 5, 6, 7, 8, 1, 9, 10, 11, 6} //nolint:lll,dupl // it's learning code

	var start, finish time.Time

	log.Print("sortBubbleInPlace: ")
	start = time.Now()
	sortBubbleInPlace(slc)
	finish = time.Now()
	log.Println(finish.Sub(start))

	log.Print("sortBubbleReturn: ")
	start = time.Now()
	slc = sortBubbleReturn(slc)
	finish = time.Now()
	log.Println(finish.Sub(start))

	log.Print("sortReturn: ")
	start = time.Now()
	slc = sortReturn(slc)
	finish = time.Now()
	log.Println(finish.Sub(start))

	log.Print("sortStandard: ")
	start = time.Now()
	sortStandard(slc)
	finish = time.Now()
	log.Println(finish.Sub(start))

	log.Print("sortStandardParam: ")
	start = time.Now()
